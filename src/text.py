...
hp_stat_value = text(["Profile"], str(player.hp_stat), (900,242), pg.font.Font(def_link,heading1_size),def_colour)
mana_stat_value = text(["Profile"], str(player.mana_stat), (900,326), pg.font.Font(def_link,heading1_size),def_colour)
int_stat_value = text(["Profile"], str(player.int_stat), (900,410), pg.font.Font(def_link,heading1_size),def_colour)
