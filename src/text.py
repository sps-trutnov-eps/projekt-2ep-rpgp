...
profile_intro = text_wall(["Profile tutorial table"], True, "", pg.font.Font(def_link,regular_size), def_colour)
campaign_intro = text_wall(["Campaign tutorial table"], True, "", pg.font.Font(def_link,regular_size), def_colour)
