...
fireball = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/fireball.png"), "Fireball", "Cast a fireball and\nshoot it at your enemy!","Costs 50 mana, deals X damage to enemy\nand applies the On Fire! debuff.", 5, "Skill board", True, 50)
water_blast = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/water_blast.png"), "Water Blast", "Cast a big wave of\nwater against your enemy!", "Costs 30 mana, deals X damage and\napplies the Wet! debuff.", 5, "Skill board", False, 30)
rock_throw = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/rock_throw.png"), "Rock Throw", "Throw a large boulder at your enemy!", "Costs 30 mana, deals X damage to enemy and\nstuns them for X rounds", 5, "Skill board", False, 30)
ice_storm = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/ice_storm.png"), "Ice Storm", "Send a shower of sharp icicles\ndown on your enemy!", "Costs 30 mana, deals X damage to enemy and\napplies the Frozen! debuff.", 5, "Skill board", False, 30)
poison_dart = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/poison_dart.png"), "Poison Dart", "Blow a poison dart at your enemy!", "Costs 30 mana and applies the Poisoned! debuff.", 5, "Skill board", False, 30)
lightning_bolt = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/lightning_bolt.png"), "Lightning Bolt", "Shoot a lightning bolt at your enemy!", "Costs 30 mnana, deals X damage to enemy and\napplies the Shocked! debuff.", 5, "Skill board", False, 30)
life_steal = skill(pg.image.load(DATA_ROOT + "/data/textures/icons/skills/life_steal.png"), "Life Steal", "Steal health for yourself\nfrom your enemy!", "Costs 30 mana, steals X health from enemy\nand gives it to you.", 5, "Skill board", False, 30)
