...
# XP, pak Goldy
levels[0].get_rewards(80,5)
levels[1].get_rewards(100,15)
levels[2].get_rewards(120,25)
levels[3].get_rewards(140,30)
levels[4].get_rewards(150,40)
levels[5].get_rewards(160,50)
levels[6].get_rewards(170,55)
levels[7].get_rewards(180,60)
levels[8].get_rewards(190,75)
levels[9].get_rewards(200,100)
levels[10].get_rewards(210,120)
levels[11].get_rewards(210,150)
levels[12].get_rewards(210,175)
levels[13].get_rewards(210,200)
levels[14].get_rewards(210,220)
levels[15].get_rewards(210,240)
levels[16].get_rewards(210,260)
levels[17].get_rewards(210,280)
levels[18].get_rewards(210,300)
