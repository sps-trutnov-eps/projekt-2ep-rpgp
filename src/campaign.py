...
# XP, pak Goldy
levels[0].get_rewards(80,50)
levels[1].get_rewards(100,80)
levels[2].get_rewards(120,120)
levels[3].get_rewards(140,130)
levels[4].get_rewards(150,140)
levels[5].get_rewards(160,160)
